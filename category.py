...
class categoryClass:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style",40,"bold"),bg="#B00857",fg="#E6E6FA",bd=3,relief=RIDGE).place(x=50,y=10,width=1000,height=60)   
