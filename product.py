...
class Productclass:
    def __init__(self,root):
        ...
        product_Frame=Frame(self.root,bd=2,relief=RIDGE,bg="#FFE4B5")
        product_Frame.place(x=10,y=10,width=450,height=480)
        #=====title=====
        
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18),bg="#B00857",fg="#E6E6FA",bd=3,relief=RIDGE).pack(side=TOP,fill=X)
    
      #======column1
        lbl_Category=Label(product_Frame,text="Category",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=60)
        lbl_Supplier=Label(product_Frame,text="Supplier",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=110)
        lbl_product_name=Label(product_Frame,text="Name",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=160)
        lbl_Price=Label(product_Frame,text="Price",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=210)
        lbl_qty=Label(product_Frame,text="Quantity",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=260)
        lbl_Status=Label(product_Frame,text="Status",font=("goudy old style",15),bg="#FFE4B5").place(x=30,y=310)
