...
class BillClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Ramakant Plywood & Hardware",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#B00857",fg="#E6E6FA",bd=3,relief=RIDGE,padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        ProductFrame2=Frame(ProductFrame1,bd=4,relief=RIDGE,bg="#FFE4B5")
        ProductFrame2.place(x=2,y=42,width=398,height=90)

 
        lbl_search=Label(ProductFrame2,text="Search Product | By Name",font=("times new roman",15,"bold"),bg="#FFE4B5",fg="#B00857").place(x=2,y=5)

        lbl_search=Label(ProductFrame2,text="Product Name",font=("times new roman",15,"bold"),bg="#FFE4B5").place(x=2,y=45)
        ...
        #=====Billing Area====
        billFrame=Frame(self.root,bd=2,relief=RIDGE,bg='#FFE4B5')
        ...
        #====Footer=====
        footer=Label(self.root,text="RPAH-Ramakant Plywood & Hardware\nArjun Nagar Kasoda",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
