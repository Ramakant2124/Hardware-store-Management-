...
class employeeClass:
    def __init__(self,root):
      ...
      #====options===
        ...
        #=====title===
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#B00857",fg="#E6E6FA",bd=3,relief=RIDGE).place(x=50,y=100,width=1000)
        
        
        #=====conetent======
        #====row1=====
        lbl_empide=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="#FFE4B5").place(x=50,y=150)
        lbl_gender=Label(self.root,text="Gender",font=("goudy old style",15),bg="#FFE4B5").place(x=350,y=150)
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="#FFE4B5").place(x=750,y=150)
        ...
        txt_gender=Entry(self.root,textvariable=self.var_gender,font=("goudy old style",15),bg="#FFE4B5").place(x=500,y=150,width=180)
        ...
        #=======row 2=======
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="#FFE4B5").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="#FFE4B5").place(x=350,y=190)
        lbl_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="#FFE4B5").place(x=750,y=190)
        ...
        #=======row 3 =======
        lbl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="#FFE4B5").place(x=50,y=230)
        lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="#FFE4B5").place(x=350,y=230)
        lbl_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="#FFE4B5").place(x=750,y=230)
        ...
        txt_utype=Entry(self.root,textvariable=self.var_utype,font=("goudy old style",15),bg="#FFE4B5").place(x=850,y=230,width=180)
        ...
        cmb_utype.current(0)
         ...
         #=======row 4 =======
        lbl_city=Label(self.root,text="City",font=("goudy old style",15),bg="#FFE4B5").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="#FFE4B5").place(x=500,y=270)
